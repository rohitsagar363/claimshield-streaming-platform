...
from producers.scenario_data import claim_submissions


def main() -> None:
    parser = argparse.ArgumentParser(description="Produce claim submission events.")
    ...
    def record_batches():
        ...
        for batch_number in batches:
            records = claim_submissions(batch_number=batch_number)
            if args.limit > 0:
